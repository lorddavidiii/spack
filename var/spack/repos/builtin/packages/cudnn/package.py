...
class Cudnn(Package):
    ...
    version('7.6.4-10.0-x86_64', sha256='417bb5daf51377037eb2f5c87649000ca1b9cec0acb16cfe07cb1d3e9a961dbf',
    ...
    depends_on('cuda@10:', when='@7.5.0-10.0-ppc64le,7.5.0-10.0-x86_64,7.5.1-10.0-ppc64le,7.5.1-10.0-x86_64,7.6.4-10.0-x86_64')
